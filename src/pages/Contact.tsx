  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="pt-24 pb-16 bg-gradient-to-br from-blue-50 to-indigo-100">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 leading-relaxed">
            Whether you have a clear vision or just an idea, we'd love to hear
            from you. Fill out the form or email us directly.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 lg:grid lg:grid-cols-2 lg:gap-16">
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-blue-600 pl-4">
                  ...
                  <p className="text-gray-600 text-sm">
                    Most websites are completed within 2-6 weeks, depending on
                ...
                <div className="border-l-4 border-blue-600 pl-4">
                  ...
                  <p className="text-gray-600 text-sm">
                    Yes, we provide maintenance packages to keep your website
                ...
                <div className="border-l-4 border-blue-600 pl-4">
                  ...
                  <p className="text-gray-600 text-sm">
                    We'll discuss your goals, provide strategic advice, and
