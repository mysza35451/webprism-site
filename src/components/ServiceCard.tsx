...
const ServiceCard = ({ icon: Icon, title, description }: ServiceCardProps) => {
  return (
    <div className="bg-soft-white p-8 rounded-xl shadow-sm border border-light-silver hover:shadow-lg group transition-all duration-300 hover:border-prism-blue/30 transform hover:-translate-y-1">
